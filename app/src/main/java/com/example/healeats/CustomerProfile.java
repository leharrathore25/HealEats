            ...
            imageRef.putFile(imageUri)
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(CustomerProfile.this, "Failed", Toast.LENGTH_SHORT).show();
                        }
                    });
        } else {
            Toast.makeText(CustomerProfile.this, "No image selected", Toast.LENGTH_SHORT).show();
        }
    }
            ...
            db.collection("users")
                    ...
                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void aVoid) {
                            Toast.makeText(CustomerProfile.this, "Profile picture added successfully", Toast.LENGTH_SHORT).show();
                        }
                    })
                    .addOnFailureListener(new OnFailureListener() {
                        @Override
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(CustomerProfile.this, "Failed to add profile picture", Toast.LENGTH_SHORT).show();
                        }
                    });
        } else {
            Log.d("UserProfile.this","NUll");
            Toast.makeText(CustomerProfile.this, "Null", Toast.LENGTH_SHORT).show();
        }
    }
